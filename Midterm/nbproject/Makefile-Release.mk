...
.NO_PARALLEL:${OBJECTDIR}/Question\ 1\ .o
${OBJECTDIR}/Question\ 1\ .o: Question\ 1\ .cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Question\ 1\ .o Question\ 1\ .cpp
